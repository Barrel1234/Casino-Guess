...
void play() {
	...
	cout << endl << endl;
	cout << "Enter Deposit Money to Start Game : Rs ";
	cin >> totalMoney;
	...
	do{
		system("cls");
	        ...
	        cout << "\nCurrent balance is Rs " << totalMoney << endl;
	        
	        do{
	        	cout << personName << ", Please Enter amount to bet : Rs";
	        	cin >> betMoney;
				...
				if (dice != guess) {
					totalMoney -= betMoney;
					cout << endl << endl << "You lost Rs " << betMoney << endl;
				} else {
				...
				cout << "\n" << personName << ",You have Rs " << totalMoney << endl;
				if (totalMoney == 0){
				...
				cin >> option;
			     ...
			     cout << "-------------------------------------------------------" << endl;
			     cout << "Thanks for playing. Your Current Money is Rs " << totalMoney << endl;
			     cout << "--------------------------------------------------------" << endl;
			     getch();
